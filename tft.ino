...
// #define TFT_DC     D2   // Keep unchanged
...
// TFT Display
#define TFT_CS     5   // Change to D3 or any available pin
#define TFT_RST    -1   // Keep unchanged
...
void page_RootMenu(void) {
  ...
  if (temp <= Bac_Heater_ON) {
    ...
    tft.fillRect(240, 10, 90, 16, ILI9341_RED);
    tft.setCursor(180, 10);
    tft.print("HEAT: OFF");
  }
...
void displayCurrentThreshold() {
  switch (currentThreshold) {
    ...
    case 16: tft.setCursor(10,50); tft.print("Day:"); tft.setCursor(100,100); tft.print(day);  break;
  }
}
